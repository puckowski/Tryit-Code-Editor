        ...
        return markup('div', {
            ...
            children: [
                ...
                markup('button', {
                    ...
                    children: [
                        ...(state.getCssMode() === this.CSS_MODE_LESS ? [textNode('Use Less.js 4.1.3')] : []),
                        ...(state.getCssMode() === this.CSS_MODE_NESS ? [textNode('Use Ness.js 1.0.0')] : []),
                        ...(state.getCssMode() === this.CSS_MODE_STANDARD ? [textNode('Use CSS')] : []),
                    ]
                }),
                markup('button', {
                    attrs: {
