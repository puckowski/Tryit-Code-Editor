...
const removeAfterAnimationIfNeeded = (vNode) => {
    ...
    if (vNode['slanimatedestroytarget'] !== undefined && vNode['slanimatedestroytarget'] !== '' && !vNode.slAnimateDestroy
               ...
               nodeToAnim.onanimationstart = function (animEvt) {
                ...
                nodeToAnim.onanimationend = function (animEvt) {
                    ...
                    if (!s._router.currentRoute.animateDestroy) {
                        ...
                        nodeToAnim.onanimationend = null;//animProxy;
                        nodeToAnim.onanimationstart = null;//animStartProxy;
                    } else {
                    ...
                    nodeToAnim.onanimationend = null;
                    nodeToAnim.onanimationstart = null;
                   nodeToAnim.classList='';
                    nodeToAnim.style.animation = 'none';
                    nodeToAnim.removeAttribute('slanimatedestorytarget');
                    nodeToAnim.slanimatedestroytarget = null;
                    s._isAnimatingKeyed = null;
                ...
                if (s._router.currentRoute && vNode.id !== s._router.currentRoute.root) {
                    ...
                    vNode.removeAttribute('slanimatedestorytarget');
                    vNode.slanimatedestroytarget = null;
                    s._isAnimatingKeyed = null;
                    vNode.remove();
                    s._updateMap.delete(vNode.id);
                } else if (routeCount === s._router.count) {
        ...
        vNode.onanimationend = function (animEvt) {
            ...
            vNode.onanimationend = null;//animProxy;
            vNode.onanimationstart = null;//animStartProxy;
            vNode.style.animation = 'none';
            vNode.slanimatedestroytarget = null;
            s._isAnimatingKeyed = null;
            vNode.classList='';
...
const diffVDom = (vOldNode, vNewNode, viewModel = null) => {
    ...
    if (vOldNode &&
        ...
        if (vNewNode.tagName) {
            ...
            vOldNode.onanimationend = null;
                vOldNode.onanimationstart = null;
                vOldNode.style.animation = 'none';
                vOldNode.removeAttribute('slanimatedestorytarget');
                vOldNode.slanimatedestroytarget = null;
                s._isAnimatingKeyed = null;
                vOldNode.classList='';
            vOldNode = el;
        } else {
        ...
        if (key.test(routeStr)) {
            ...
            if (destroyEleList) {
                destroyEleList.forEach(destroyEle => {
                    ...
                    destroyEle.onanimationend = null;
                destroyEle.onanimationstart = null;
                if (destroyEle.nodeType !== 3) {
                destroyEle.style.animation = 'none';
                destroyEle.classList='';
                s._isAnimatingKeyed = null;
                destroyEle.slanimatedestroytarget = null;
                destroyEle.removeAttribute('slanimatedestorytarget');
                }
                });
